...
LABEL de.eq3.hmip.plugin.metadata="{\"pluginId\":\"de.homematicip.plugin.velux\",\"issuer\":\"Fabio Renner\",\"version\":\"1.0.0\",\"hcuMinVersion\":\"1.4.7\",\"scope\":\"LOCAL\",\"friendlyName\":{\"de\":\"Velux (KLF-200)\",\"en\":\"Velux (KLF-200)\"},\"description\":{\"de\":\"Bindet Velux io-homecontrol Geraete via KLF-200 Gateway in Homematic IP ein.\",\"en\":\"Bridges Velux io-homecontrol devices via KLF-200 gateway into Homematic IP.\"},\"settings\":[],\"changelog\":\"1.0.0 - Initial public release.\",\"logsEnabled\":true}"
