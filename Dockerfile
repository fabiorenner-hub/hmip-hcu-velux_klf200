...
LABEL de.eq3.hmip.plugin.metadata="{\"pluginId\":\"de.homematicip.plugin.velux\",\"issuer\":\"Fabio Renner\",\"version\":\"1.0.2\",\"hcuMinVersion\":\"1.4.7\",\"scope\":\"LOCAL\",\"friendlyName\":{\"de\":\"Velux (KLF-200)\",\"en\":\"Velux (KLF-200)\"},\"description\":{\"de\":\"Bindet Velux io-homecontrol Geraete via KLF-200 Gateway in Homematic IP ein.\",\"en\":\"Bridges Velux io-homecontrol devices via KLF-200 gateway into Homematic IP.\"},\"settings\":[],\"changelog\":\"1.0.2 - Daily maintenance is now selectable: OFF, RECONNECT (soft) or REBOOT (hardware power-cycle of the KLF-200). 90s reboot cooldown so the reconnect loop stays quiet while the gateway boots.\\n1.0.1 - Configurable keep-alive interval and daily KLF-200 reset (default 03:00 local). Cleaner connect-error logs and ECONNREFUSED back-off.\\n1.0.0 - Initial public release.\",\"logsEnabled\":true}"
